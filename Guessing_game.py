...
lbl2 = Label(root, text="", fg="red", font="comicsansms 15 bold", bg="gray")
...
# new_game_button = Button(root, text="New Game",relief=RAISED,bg="grey",bd=3, command=output,font="times 15 bold")
# new_game_button.place(x=120,y=230)
root.mainloop()